...
new #[Layout('layouts.app')] class extends Component
{
    ...
    public function tokens(): array
    {
        $w = $this->currentWord;
        if (! $w) return [];
        return $this->tokenize($w->definition);
    }
    ...
    private function shuffleCurrent(): void
    {
        ...
        // Try a few times to avoid the rare case where shuffle returns sorted order
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="min-w-0">
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight truncate">
                    Organize Definition · Unidad {{ $unit->unit_number }}
                </h2>
        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            @if ($totalUnique === 0)
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8 text-center">
                    <p class="text-gray-600 dark:text-gray-400">Esta unidad no tiene definiciones aptas para este ejercicio.</p>
            ...
            @elseif ($finished)
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8 text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">¡Dominaste todas las definiciones!</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Reordenaste correctamente las {{ $totalUnique }} definiciones.</p>
            ...
            @else
                ...
                <div wire:key="org-def-{{ $word->id }}-{{ $position }}"
                    ...
                    <div class="p-5 sm:p-6">
                        ...
                        <div class="text-center mb-5">
                            <p class="text-xs uppercase tracking-wide font-semibold {{ $palette['text'] }} mb-2">Ordena la definición de</p>
                            ...
                            @if ($word->definition_audio)
                                <div x-data="{ playing: false }"
                                    ...
                                    <button type="button"
                                        ...
                                        <span x-text="playing ? 'Detener' : 'Escuchar definición'">Escuchar definición</span>
                                    </button>
